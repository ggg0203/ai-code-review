...
async def get_ci_status(
    ...
    try:
                ...
                try:
                    ...
                    if jobs_resp.status_code == 200:
                        ...
                        for job in jobs:
                            ...
                            stages.append(Stage(name=job.get("name", "unknown"), status=s, duration=j_dur))
                except Exception:
                    pass
        ...
        return CIStatusResponse(success_rate=rate, avg_duration=avg_dur, total_runs=total, builds=builds)
